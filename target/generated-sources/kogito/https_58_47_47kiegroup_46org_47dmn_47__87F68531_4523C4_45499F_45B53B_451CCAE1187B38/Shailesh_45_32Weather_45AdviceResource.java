 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__87F68531_4523C4_45499F_45B53B_451CCAE1187B38;
...
@Path("/Shailesh- Weather-Advice")
public class Shailesh_45_32Weather_45AdviceResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_87F68531-23C4-499F-B53B-1CCAE1187B38", "Shailesh- Weather-Advice");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_87F68531-23C4-499F-B53B-1CCAE1187B38", "Shailesh- Weather-Advice", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Shailesh- Weather-Advice") + ".dmn_nologic")));
    }
